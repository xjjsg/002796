...
class CombinedStrategyV5(BaseStrategy):
    """
    V5 keeps the two useful lines separate:
    1. cross-day position selection: choose the 40%-100% target around 70%;
    2. intraday T0: trim rich local rallies and cover local dips.

    The late-session experimental factors are not promoted here because they
    reduced both full-sample and real-position handoff performance.
    """
